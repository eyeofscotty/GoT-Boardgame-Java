...
public class HouseTyrell implements House {
    ...
    private ArrayList<OrderToken> availableOrderTokens;
    ArrayList<OrderToken> allOrderTokens;

    public HouseTyrell(String name, int numSupply, int numPowerTokens, int numCastles, int numStrongholds, int ravenTrack, int ironThroneTrack, int swordTrack, int numStars){
        this.name = name;
...
//        this.houseCardsInHand.add(References.References.MACE_TYRELL);
//        this.houseCardsInHand.add(References.References.SER_LORAS_TYRELL);
//        this.houseCardsInHand.add(References.References.SER_GARLEN_TYRELL);
//        this.houseCardsInHand.add(References.References.RANDELL_TARLY);
//        this.houseCardsInHand.add(References.References.ALESTER_FLORENT);
//        this.houseCardsInHand.add(References.References.MARGAERY_TYRELL);
//        this.houseCardsInHand.add(References.References.QUEEN_OF_THORNS);
